...
use Akeneo\Pim\Enrichment\Component\Product\Validator\ConstraintGuesser\EmailGuesser as AkeneoEmailGuesser;
 ...
 */
class EmailGuesser extends AkeneoEmailGuesser
{
    /**
     * {@inheritdoc}
     */
